...
<tr><td align="left">
<ul>
<li><a href="info.php">Change Email and/or Password</a></li>
<li><a href="address.php">Modify Stored Addresses</a></li>
<li><a href="custom.php">Custom Products</a></li>
<li><b><a href="history.php">Complete Order History</a></b></li>
<?
	$results = mysql_query("select * from affiliate where account = '".$_SESSION['account_id']."'", $dbh);
	if(mysql_num_rows($results))
		print "<li><a href=\"affiliate-report.php\">Affiliate Report</a></li>";
?>
</ul>
</td></tr>
<?
...
<tr class="bar"><td align="left" style="font-weight:bold;font-size:14px;">Order #<?=$order['id']?></td><td align="right"><a href="order.php?<?=$order['id']?>" style="font-size:14px;font-weight:bold;color:#FFFFFF;">View Invoice</a></td></tr>
<tr><td align="left">
...
<div style="text-align:center;font-size:14px;margin:10px 0;"><a href="history.php"><b>View your Complete Order History</a></b></li>
<?
	}
?>
