 ...
 */
include_once('Mage/Sales/Model/Quote/Address/Rate.php');
class Concalma_Dropship_Model_Quote_Address_Rate extends Mage_Sales_Model_Quote_Address_Rate
{
	protected $_address;
