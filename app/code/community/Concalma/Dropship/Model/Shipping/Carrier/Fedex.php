 ...
 */
include_once('Mage/Usa/Model/Shipping/Carrier/Fedex.php');
class Concalma_Dropship_Model_Shipping_Carrier_Fedex
    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    public function setRequest(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        if ($request->getData('warehouse') != '' && $request->getData('warehouse') != null) {
        	...
        	//set the data
        	 $request->setFedexAccount($warehouseInfo['fedex_account_id']);
        }
    	//end of hook
        ...
        if ($request->getData('warehouse') != '' && $request->getData('warehouse') != null) {
        	...
        	//set the data
          $r->setMeterNumber($warehouseInfo['fedexsoap_meter_number']);
          $r->setKey($warehouseInfo['fedexsoap_key']);//fedexsoap_key
          $r->setPassword($warehouseInfo['fedexsoap_password']);
        }
    	//end of hook
