 ...
 */
include_once('Mage/Usa/Model/Shipping/Carrier/Ups.php');
class Concalma_Dropship_Model_Shipping_Carrier_Ups
...
XMLAuth;
    ...
    protected function _doShipmentRequest(Varien_Object $request)
    {
    	...
    	//thuydebug
    	//Mage::log($request, Zend_Log::ERR);
    	Mage::log('thuy carrier is ups', Zend_Log::ERR);
    	//thuydebug
        $this->_prepareShipmentRequest($request);
        $result = new Varien_Object();
        $xmlRequest = $this->_formShipmentRequest($request);
        $xmlResponse = $this->_getCachedQuotes($xmlRequest);
         Mage::log($xmlResponse, Zend_Log::ERR);
