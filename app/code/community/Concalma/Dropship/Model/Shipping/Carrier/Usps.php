 ...
 */
include_once('Mage/Usa/Model/Shipping/Carrier/Usps.php');
class Concalma_Dropship_Model_Shipping_Carrier_Usps
    ...
    implements Mage_Shipping_Model_Carrier_Interface
{
    ...
    public function setRequest(Mage_Shipping_Model_Rate_Request $request)
    {
        ...
        if ($request->getData('warehouse') != '' && $request->getData('warehouse') != null) {
        	...
        	//set the data
        	 $request->setUspsUserid($warehouseInfo['usps_user_id ']);
        }
    	//end of hook
    ...
    protected function _formUsExpressShipmentRequest(Varien_Object $request)
    {
        ...
        if ($request->getData('warehouse') != '' && $request->getData('warehouse') != null) {
        	...
        	//set the data
        	 $xml->addAttribute('USERID', $warehouseInfo['usps_user_id']);
